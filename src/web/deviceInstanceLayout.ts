...
export const devicePoints: DevicePoint[] = [
  ...
  { deviceId: 'living_ac_01', roomId: 'living_room', x: -0.95, z: -3.9, y: 0.56, mount: 'wall', rotation: Math.PI },
  ...
  { deviceId: 'master_light_01', roomId: 'master_bedroom', x: -0.35, z: -0.95, y: 0.62, mount: 'ceiling' },
  ...
  { deviceId: 'child_light_01', roomId: 'child_bedroom', x: 3.25, z: -1.15, y: 0.62, mount: 'ceiling' },
  { deviceId: 'child_ac_01', roomId: 'child_bedroom', x: 3.55, z: -0.45, y: 0.56, mount: 'wall', rotation: -Math.PI / 2 },
  { deviceId: 'study_light_01', roomId: 'study', x: 4.9, z: -1.85, y: 0.62, mount: 'ceiling' },
