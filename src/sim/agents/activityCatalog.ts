...
const activityTemplates: ActivityTemplate[] = [
  ...
  activity('study_homework', ['schoolwork'], [], [{ resourceId: 'homework_materials', quantity: 1 }], 'living_room', { kind: 'uniform', min: 35, max: 80 }, 0.22, ['open_books', 'focus'], [{ need: 'taskPressure', delta: -50 }, { need: 'stress', delta: 8 }]),
  ...
  activity('load_dishwasher', ['chore'], [], [{ resourceId: 'clean_dishes', quantity: 1 }], 'kitchen', { kind: 'uniform', min: 4, max: 10 }, 0.45, ['collect_dishes', 'load_rack'], [{ need: 'taskPressure', delta: -10 }]),
  ...
  activity('refill_medicine', ['health', 'restock'], [], [{ resourceId: 'door_access', quantity: 1 }], 'entrance', { kind: 'uniform', min: 8, max: 20 }, 0.5, ['order_refill', 'collect_delivery', 'restock_medicine_box'], [{ need: 'healthConcern', delta: -12 }, { need: 'taskPressure', delta: -8 }]),
